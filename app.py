...
recommendations = {
    ...
    'Potato___Late_blight': [
        "Destroy infected plants immediately — this disease spreads fast.",
        "Apply a fungicide containing metalaxyl or copper compounds.",
        "Avoid working in the field when leaves are wet.",
        "Monitor nearby healthy plants closely for new symptoms."
    ],
    'Potato___healthy': [
        "No disease detected — plant appears healthy.",
    ...
    'Tomato___Early_blight': [
        ...
        "Apply a fungicide containing chlorothalonil or mancozeb.",
        "Add mulch around the base of plants to prevent soil splash onto leaves.",
        "Water at the base of the plant, not on the leaves."
    ],
    'Tomato___Late_blight': [
        "Remove and destroy infected plants immediately — this disease spreads fast.",
        "Apply a fungicide containing metalaxyl or copper compounds.",
        "Avoid overhead irrigation.",
        "Do not compost infected plant material."
    ],
    'Tomato___Leaf_Mold': [
        "Prune plants and improve spacing for better air circulation.",
        "Reduce humidity, especially in greenhouse conditions.",
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': [
        ...
        "Apply a miticide or insecticidal soap if infestation is severe.",
        "Encourage natural predators such as ladybugs.",
        "Monitor plants weekly, mites spread quickly in dry weather."
    ],
    'Tomato___Target_Spot': [
        "Remove infected leaves.",
        "Improve air circulation around plants.",
        "Apply a fungicide containing chlorothalonil or copper.",
        "Avoid overhead watering."
    ],
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': [
        "Remove and destroy infected plants — there is no cure once infected.",
        "Control whitefly populations, the primary carrier, using insecticides or sticky traps.",
